...
public class ConsecutivosCntDetalleDtoUpdateValidator : AbstractValidator<ConsecutivosCntDetalleDtoUpdate>
{
    public ConsecutivosCntDetalleDtoUpdateValidator(IRepositorioConsecutivoCntDetalle repo
