...
public class AsientosContablesDetalleDtoUpdateValidator : AbstractValidator<AsientosContablesDetalleDtoUpdate>
{
    public AsientosContablesDetalleDtoUpdateValidator(IRepositorioAsientoContableDetalle repo
