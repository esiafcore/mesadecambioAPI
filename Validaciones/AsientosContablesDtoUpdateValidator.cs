...
public class AsientosContablesDtoUpdateValidator : AbstractValidator<AsientosContablesDtoUpdate>
{
    public AsientosContablesDtoUpdateValidator(IRepositorioAsientoContable repo
