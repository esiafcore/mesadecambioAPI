...
public class TransaccionesBcoDetalleDtoUpdateValidator : AbstractValidator<TransaccionesBcoDetalleDtoUpdate>
{
    public TransaccionesBcoDetalleDtoUpdateValidator(IRepositorioTransaccionBcoDetalle repo
